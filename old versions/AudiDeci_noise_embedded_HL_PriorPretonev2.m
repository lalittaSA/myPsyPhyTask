function [task, list] = AudiDeci_noise_embedded_HL_PriorPretonev2(dispInd,ampRanges,subjId,optionName,eyeTrackerOn)
...
window_width = 0.2*screensize(1);
window_height = 0.2*screensize(2);
...
toneAmpH = ampRanges(2,2)*0.75;
toneAmpL = ampRanges(1,2)*0.75;

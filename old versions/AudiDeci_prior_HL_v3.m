function [task, list] = AudiDeci_prior_HL_v3(dispInd)

% edited 20170130: version 3 split 0-coherence trials into 0.001 & -0.001 & constant prior cue
% edited 20170125: version 2 vertical cue + blocked prior

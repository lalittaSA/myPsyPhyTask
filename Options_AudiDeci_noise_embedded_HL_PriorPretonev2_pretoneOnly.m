function options = Options_AudiDeci_noise_embedded_HL_PriorPretonev2_pretoneOnly
%% frequency settings
...
%% pretone settings
% options.nPreTones = 2:12;
options.preToneCombination = 'permute'; % select from {'single','combine','permute'};
...
options.snrLevels = [-1 -0.5 -0.25 -0.1 -0.05 0.05 0.1 0.25 0.5 1];

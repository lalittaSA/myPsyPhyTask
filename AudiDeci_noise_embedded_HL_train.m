function [task, list] = AudiDeci_noise_embedded_HL_train(dispInd,ampRanges,subj_id)
...
sequenceTypes = {'HHHHX','LHLHX','LLLLX','HLHLX'}; % from {'HHHHX','LLLLX','HLHLX','LHLHX'} | X: decision tone | all sequences must have the same length!

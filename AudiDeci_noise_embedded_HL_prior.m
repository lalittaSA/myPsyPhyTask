function [task, list] = AudiDeci_noise_embedded_HL_prior(dispInd,ampRanges,subjId,optionName,eyeTrackerOn)

% 20170601: created by Lalitta - auditory decision task - 
% 2-alternative forced choice task: low-high frequency discrimination
% stimuli consist of tones embeded in noise with an amplitude that varies across trials
% + prior manipulation
...
yLevel = trialVarPrior(counter)*2/3;
...
if list{'Eyelink'}{'eyeTrackerOn'}
    ...
    postStimOnTimes = list{'Eyelink'}{'preStimOnTimestamps'};

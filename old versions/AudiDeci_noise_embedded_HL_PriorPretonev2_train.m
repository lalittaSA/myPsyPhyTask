function [task, list] = AudiDeci_noise_embedded_HL_PriorPretonev2_train(dispInd,ampRanges,subjId,optionName,eyeTrackerOn)
...
optionFunctionName = ['Options_' curTask(1:end-6) '_' optionName];
...
list{'Timestamps'}{'rtOffset'} = rtOffset;list{'Timestamps'}{'rtOffset'} = rtOffset;

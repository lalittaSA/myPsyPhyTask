...
if ~run_calibOnly
    ...
    if trainOnly
        ...
        subjID = 'test';
        optionName = 'train';
        [task_main list_main] = AudiDeci_noise_embedded_HL_prior(1,subjAmpRange,subjID,optionName,eyeTrackerOn);
    ...
    data_table_main = table((1:nTrials)',trialVarAmp,trialVarSNR,trialVarPrior,trialVarStimSeq,trialVarPreToneSeq,isH,...
        success,choices,rt,trialStarts,trialStops,stimStarts,stimStops,choiceTimeStamp,rtOffset,...
        'VariableNames',{'trialID','stimAmplitude','SNR','prior','stimSequence','pretoneSeq','isH',...

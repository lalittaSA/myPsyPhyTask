...
%% generate pretone length distribution (minimum block then multiplied by conditions) that minimizes predictable hazard rate (exp decay with cutoff: at 12)
preToneLengthEdges = [-1,1,5,11]; % to split preTone lengths into groups
